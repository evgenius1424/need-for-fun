...
pub use physics_core::constants::{
    ...
    GRENADE_RISE_DAMPING, HITSCAN_PLAYER_RADIUS, MACHINE_RANGE, PICKUP_AMMO, PICKUP_RADIUS,
    PLASMA_SPLASH_DMG, PLASMA_SPLASH_PUSH, PLASMA_SPLASH_RADIUS, PROJECTILE_GRAVITY,
    PROJECTILE_SPEED, RAIL_RANGE, RESPAWN_TIME, SELF_DAMAGE_REDUCTION, SELF_HIT_GRACE,
    SHAFT_RANGE, SHOTGUN_PELLETS, SHOTGUN_RANGE, SHOTGUN_SPREAD, SPAWN_PROTECTION,
    SPLASH_RADIUS, WEAPON_PUSH, ARMOR_ABSORPTION, DEFAULT_AMMO, MAX_ARMOR, MAX_HEALTH,
    MEGA_HEALTH, QUAD_DURATION, QUAD_MULTIPLIER,
};
